...
// components
import Facets from 'components/core/facets/facets';
...
class ProductVariants extends Component {
  ...
  getSkuByCode(product: Product, code: string): Sku {
  ...
  getFacets(product: Product): Array<TFacet> {
  ...
  getUnselectedFacets(product: Product = this.props.product): Array<string> {
