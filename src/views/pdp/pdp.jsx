...
import ProductVariants from 'views/product-variants/product-variants';
import GiftCardForm from 'views/gift-card-form';
import ImagePlaceholder from 'views/products-item/image-placeholder';
